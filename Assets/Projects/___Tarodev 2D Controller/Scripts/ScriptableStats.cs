...
namespace TarodevController
{
    ...
    public class ScriptableStats : ScriptableObject
    {
        ...
        [Header("WALL CLIMB")]
        [Tooltip("Distance to detect walls for climbing")]
        public float WallClimbDistance = 0.5f; // The distance at which to detect a wall
        [Tooltip("Speed of climbing up the wall")]
        public float WallClimbSpeed = 5f; // The speed at which the player climbs
